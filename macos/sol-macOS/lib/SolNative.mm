...
RCT_EXTERN_METHOD(executeUserScript : (NSString)source name : (NSString)name
                      arguments : (NSArray *)arguments resolver : (
                          ...
                          RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(executeScriptFile : (NSString)path name : (NSString)name
                      arguments : (NSArray *)arguments showOutput : (
                          BOOL)showOutput resolver : (
                          RCTPromiseResolveBlock)resolve rejecter : (
                          RCTPromiseRejectBlock)reject)
...
RCT_EXTERN_METHOD(turnOffCommandEnterListener)
RCT_EXTERN_METHOD(turnOnCommandEnterListener)
...
RCT_EXTERN_METHOD(setSearchWindowAnimation : (NSDictionary)settings)
...
RCT_EXTERN_METHOD(toggleBackgroundSounds : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(toggleMigraineMode : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(toggleRedScreen : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject)
